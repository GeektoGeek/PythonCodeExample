...
DecemberNYC2019 = pd.read_csv('C:/Users/test/Documents/CventDataCameFromJoe/2019/DecemberNYC2019Report.csv',encoding= 'iso-8859-1')

DecemberNYC2019.columns = DecemberNYC2019.columns.str.replace(' ', '')
...
check = DecemberNYC2019.drop_duplicates(subset = ["QuestionText"])

check= check.loc[pd.notnull(check.QuestionText)]

###Start with one question

DFFF1_DecemberNYC2019U= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'What are the primary carriers you write with?']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_PC= DFFF1_DecemberNYC2019U.loc[pd.notnull(DFFF1_DecemberNYC2019U.FullName)]

### end of one question

###Start with question two

DFFF1_DecemberNYC2019U=  DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Please enter your Athene (Annexus) agent number.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AgentNum= DFFF1_DecemberNYC2019U.loc[pd.notnull(DFFF1_DecemberNYC2019U.FullName)]
...
DFFF1_DecemberNYC2019U1= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Are you a registered rep?']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_RegisteredRep= DFFF1_DecemberNYC2019U1.loc[pd.notnull(DFFF1_DecemberNYC2019U1.FullName)]
...
DFFF1_DecemberNYC2019U2= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Annual Annuity Premium']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AnnuityPremium= DFFF1_DecemberNYC2019U2.loc[pd.notnull(DFFF1_DecemberNYC2019U2.FullName)]
...
DFFF1_DecemberNYC2019U3= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Are you currently contracted with Athene (through Annexus)']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_CurrentlyAnneContracted= DFFF1_DecemberNYC2019U3.loc[pd.notnull(DFFF1_DecemberNYC2019U3.FullName)]
...
DFFF1_DecemberNYC2019U4= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Assets under management']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AssetManagement= DFFF1_DecemberNYC2019U4.loc[pd.notnull(DFFF1_DecemberNYC2019U4.FullName)]
...
DFFF1_DecemberNYC2019U5= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Please select your shirt size.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_tshirtSize= DFFF1_DecemberNYC2019U5.loc[pd.notnull(DFFF1_DecemberNYC2019U5.FullName)]
...
DFFF1_DecemberNYC2019U6= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Please enter the name of your broker dealer.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_brokerdealer= DFFF1_DecemberNYC2019U6.loc[pd.notnull(DFFF1_DecemberNYC2019U6.FullName)]
...
DFFF1_DecemberNYC2019U7= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Contracted with Nationwide']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_NWContracted= DFFF1_DecemberNYC2019U7.loc[pd.notnull(DFFF1_DecemberNYC2019U7.FullName)]
...
DFFF1_DecemberNYC2019U8= DecemberNYC2019.loc[DecemberNYC2019['QuestionText'] == 'Please enter your nw (Annexus) agent number.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AnnexusAgent= DFFF1_DecemberNYC2019U8.loc[pd.notnull(DFFF1_DecemberNYC2019U8.FullName)]
...
filtered_df_DecemberNYC2019 =filtered_df_combined8

filtered_df_DecemberNYC2019["EventName"]= 'DecemberNYC2019'

Out4 = filtered_df_DecemberNYC2019.to_csv(r'C:/Users/test/Documents/CventDataCameFromJoe/2019/filtered_df_DecemberNYC2019.csv', index = None, header=True)
