...
AugustNYC2019 = pd.read_csv('C:/Users/test/Documents/CventDataCameFromJoe/2019/AugustNYC2019.csv',encoding= 'iso-8859-1')

AugustNYC2019.columns = AugustNYC2019.columns.str.replace(' ', '')
...
check = AugustNYC2019.drop_duplicates(subset = ["QuestionText"])

check= check.loc[pd.notnull(check.QuestionText)]

###Start with one question

DFFF1_AugustNYC2019U= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'What are the primary carriers you write with?']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_PC= DFFF1_AugustNYC2019U.loc[pd.notnull(DFFF1_AugustNYC2019U.FullName)]

### end of one question

###Start with question two

DFFF1_AugustNYC2019U= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Please enter your Athene (Annexus) agent number.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AgentNum= DFFF1_AugustNYC2019U.loc[pd.notnull(DFFF1_AugustNYC2019U.FullName)]
...
DFFF1_AugustNYC2019U1= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Are you a registered rep?']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_RegisteredRep= DFFF1_AugustNYC2019U1.loc[pd.notnull(DFFF1_AugustNYC2019U1.FullName)]
...
DFFF1_AugustNYC2019U2= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Annual Annuity Premium']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AnnuityPremium= DFFF1_AugustNYC2019U2.loc[pd.notnull(DFFF1_AugustNYC2019U2.FullName)]
...
DFFF1_AugustNYC2019U3= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Are you currently contracted with Athene (through Annexus)']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_CurrentlyAnneContracted= DFFF1_AugustNYC2019U3.loc[pd.notnull(DFFF1_AugustNYC2019U3.FullName)]
...
DFFF1_AugustNYC2019U4= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Assets under management']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AssetManagement= DFFF1_AugustNYC2019U4.loc[pd.notnull(DFFF1_AugustNYC2019U4.FullName)]
...
DFFF1_AugustNYC2019U5= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Please select your shirt size.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_tshirtSize= DFFF1_AugustNYC2019U5.loc[pd.notnull(DFFF1_AugustNYC2019U5.FullName)]
...
DFFF1_AugustNYC2019U6= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Please enter the name of your broker dealer.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_brokerdealer= DFFF1_AugustNYC2019U6.loc[pd.notnull(DFFF1_AugustNYC2019U6.FullName)]
...
DFFF1_AugustNYC2019U7= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Contracted with Nationwide']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_NWContracted= DFFF1_AugustNYC2019U7.loc[pd.notnull(DFFF1_AugustNYC2019U7.FullName)]
...
DFFF1_AugustNYC2019U8= AugustNYC2019.loc[AugustNYC2019['QuestionText'] == 'Please enter your nw (Annexus) agent number.']

##filtered_df = DFFF1_AugustNYC2019U[DFFF1_AugustNYC2019U['FullName'].isnull()]

filtered_df_AnnexusAgent= DFFF1_AugustNYC2019U8.loc[pd.notnull(DFFF1_AugustNYC2019U8.FullName)]
...
filtered_df_AugustNYC2019= filtered_df_combined8.drop(['FullName'], axis = 1)

filtered_df_AugustNYC2019["EventName"]= 'AugustNYC2019'

Out4 = filtered_df_AugustNYC2019.to_csv(r'C:/Users/test/Documents/CventDataCameFromJoe/2019/filtered_df_AugustNYC2019.csv', index = None, header=True)
