...
data = pd.read_csv('C:/Users/DSarkar/Documents/SalesByQuarter/SalesByQuarter.csv')


data_modi = pd.read_csv('C:/Users/DSarkar/Documents/SalesByQuarter/SalesByQuarter_modi.csv')
data.head()
...
export_csv = dfff3.to_csv (r'C:\Users\DSarkar\Documents\SalesByQuarter\SFAtheneLastSubmitIDC.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path
...
export_csv = dfff4.to_csv (r'C:\Users\DSarkar\Documents\SalesByQuarter\SFAtheneLastSubmitIDC&FullNm.csv', index = None, header=True) ##Don't forget to add '.csv' at the end of the path
...
export_csv = dfff5.to_csv (r'C:\Users\DSarkar\Documents\SalesByQuarter\SFNationwideLastSubmitIDC.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path
...
export_csv = dfff6.to_csv (r'C:\Users\DSarkar\Documents\SalesByQuarter\SFNationwideLastSubmitIDC&FullNm.csv', index = None, header=True) ##Don't forget to add '.csv' at the end of the path
...
export_csv = dfff1.to_csv (r'C:\Users\DSarkar\Documents\SalesByQuarter\dfff1.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path
