...
### NPS_2019 Raw Data
##Data6 = pd.read_csv('C:/Users/test/Documents/NPS_Score/NPS_Final02062020/Data03092020/TADetractorComment.csv',encoding= 'iso-8859-1')
## Data6.info()

Data1 = pd.read_csv('C:/Users/test/Documents/NPS_Score/NPS_Final02062020/Data03092020/Annexus_PromoterComments.csv',encoding= 'iso-8859-1')
Data1.info()

### Let's bring the Annexus_Promoter 
...
## SurveyResponses = pd.read_csv('C:/Users/test/Documents/NPS_Score/NPS_Final02062020/FinalDataWithCP_FA0212.csv',encoding= 'iso-8859-1')

## SurveyResponses= Data

SurveyResponses= Data1
...
SurveyResponses2= SurveyResponses.iloc[:,[0]]

SurveyResponses2.info()

SurveyResponses2 = SurveyResponses2.replace(np.nan, '', regex=True)

SurveyResponses2['Isthereanythingelseyouwouldliketoshare']=SurveyResponses2['Isthereanythingelseyouwouldliketoshare'].astype(str)

SurveyResponses2['Isthereanythingelseyouwouldliketoshare'] =SurveyResponses2['Isthereanythingelseyouwouldliketoshare'].apply(lambda x:pre_process(x))
...
SurveyResponses2['Isthereanythingelseyouwouldliketoshare'].to_list()

tfidf = TfidfVectorizer(analyzer='word', stop_words = 'english')

##score = tfidf.fit_transform(EmailSubjectNLP['EmailSubject'])

score = tfidf.fit_transform(SurveyResponses2['Isthereanythingelseyouwouldliketoshare'])

score1 = tfidf.fit_transform(SurveyResponses2['Isthereanythingelseyouwouldliketoshare'])
...
Annexus_promotertokens_above_threshold2 = tokens_above_threshold2.to_csv (r'C:\Users\test\Documents\NPS_Score\NPS_BoardMeeting\Annexus_Promoterstokens_above_threshold2.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path

##tokens_above_threshold2 = tokens_above_threshold2.to_csv(r'C:\Users\test\Documents\NPS_Score\NPS_Final02062020\Data03092020\Ann_promotertokens_above_threshold2.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path
...
text = SurveyResponses2['Isthereanythingelseyouwouldliketoshare'][0:189]
...
# Remove punctuation
SurveyResponses3['WhyTAScore'] = SurveyResponses3['WhyTAScore'].map(lambda x: re.sub('[,\.!?]', '', x))
# Convert the titles to lowercase
SurveyResponses3['WhyTAScore'] = SurveyResponses3['WhyTAScore'].map(lambda x: x.lower())
# Print out the first rows of papers
SurveyResponses3['WhyTAScore'].head()


# Import the wordcloud library
from wordcloud import WordCloud
# Join the different processed titles together.
long_string = ','.join(list(SurveyResponses3['WhyTAScore'].values))
# Create a WordCloud object
wordcloud = WordCloud(background_color="white", max_words=20000, contour_width=2, contour_color='steelblue')
...
count_data = count_vectorizer.fit_transform(SurveyResponses3['WhyTAScore'])
...
text = filter(lambda x: x in printable, text1)
text = "".join(list(text1)) # will convert filter type object to string
print(text)

### Starting some code from here
...
lsimodel = LsiModel(corpus=corpus, num_topics=30, id2word=dictionary)
...
pyLDAvis.save_html(p, 'lda64.html')
...
# Create a WordCloud object
wordcloud5 = WordCloud(background_color="white", max_words=1000, contour_width=3, contour_color='steelblue')
# Generate a word cloud
