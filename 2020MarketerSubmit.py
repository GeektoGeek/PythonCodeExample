...
Submit2019 = pd.read_csv('C:/Users/DSarkar/Documents/MarketerSubmitAnalysis/2019Submit.csv',encoding= 'iso-8859-1')

con = sqlite3.connect("Submit2019.db")

Submit2019.to_sql("Submit2019", con, if_exists='replace')

Jan1_May2_2020 = pd.read_csv('C:/Users/DSarkar/Documents/MarketerSubmitAnalysis/2020Jan1_May2.csv',encoding= 'iso-8859-1')
...
CovidMar13_May2 = pd.read_csv('C:/Users/DSarkar/Documents/MarketerSubmitAnalysis/CovidMar13_May2.csv',encoding= 'iso-8859-1')
...
MarketerlistDW = pd.read_csv('C:/Users/DSarkar/Documents/MarketerSubmitAnalysis/MarketerlistDW.csv',encoding= 'iso-8859-1')
...
export_csv1 = checkval.to_csv (r'C:\Users\DSarkar\Documents\MarketerSubmitAnalysis\checkval.csv', index = None, header=True)

export_csv = MissedNames.to_csv (r'C:\Users\DSarkar\Documents\MarketerSubmitAnalysis\MissedNames.csv', index = None, header=True)
...
export_csv = checkval1.to_csv (r'C:\Users\DSarkar\Documents\MarketerSubmitAnalysis\checkval1.csv', index = None, header=True)


export_csv = MissedNames2020.to_csv (r'C:\Users\DSarkar\Documents\MarketerSubmitAnalysis\MissedNames2020.csv', index = None, header=True)
